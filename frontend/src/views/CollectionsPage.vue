  ...
  <main class="collections-page page-container">
    ...
    <section class="setup-section">
      ...
      <div class="setup-links">
        ...
        <RouterLink to="/collections/orders" class="setup-link">
          <div class="setup-link-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" width="22" height="22">
          ...
          <div class="setup-link-text">
            <div class="setup-link-title">Orders</div>
            <div class="setup-link-desc">View and manage incoming orders from buyers</div>
          </div>
          <span class="setup-link-arrow">→</span>
        </RouterLink>
      </div>
