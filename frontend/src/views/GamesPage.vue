  ...
  <div class="page-container games-page">
    ...
    <template v-else-if="game">
      ...
      <div class="haulonaut-ad">
        ...
        <p class="ad-stat">1000-sector universe · text-based · permadeath</p>
        <button
          class="ad-play-btn"
          :disabled="!instance"
          @click="handlePlayNow"
      ...
      <section v-if="characters.length > 0" class="current-games-section">
        <div class="section-header">
          ...
          <button class="new-game-btn" @click="openCreateModal">+ Start a New Game</button>
        </div>
      ...
      <div class="modal" role="dialog" aria-modal="true" aria-labelledby="launch-modal-title">
        ...
        <form @submit.prevent="createCharacter">
          ...
          <div class="modal-actions">
            <button type="submit" :disabled="!newCharacterName.trim() || creating">
